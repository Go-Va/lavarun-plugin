...
public class MathHelper {
    ...
    /**
     * Though it looks like an array, this is really more like a mapping.  Key (completionIndex of this array) is the upper 5 bits
     * of the result of multiplying a 32-bit unsigned integer by the B(2, 5) De Bruijn sequence 0x077CB531.  Value
     * (value stored in the array) is the unique completionIndex (from the right) of the leftmost one-bit in a 32-bit unsigned
    ...
    /**
     * Efficiently calculates the floor of the base-2 log of an integer value.  This is effectively the completionIndex of the
